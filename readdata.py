...
if __name__ == "__main__":
    ...
    writer.writerow(['package','qua0','qua1','qua2','qua3','angx','angy','angz','accx','accy','accz'])
        ...
        while True:
            if number[1] == 74:
                ...
                if first_flag == 1:
                    ...
                    writer.writerow([sensor1.sensor_data.package,sensor1.sensor_data.quaternion.qua1,sensor1.sensor_data.quaternion.qua2,sensor1.sensor_data.quaternion.qua3,sensor1.sensor_data.quaternion.qua4,sensor1.sensor_data.gyroscope.gyro_x,sensor1.sensor_data.gyroscope.gyro_y,sensor1.sensor_data.gyroscope.gyro_z,sensor1.sensor_data.acceleration.acc_x,sensor1.sensor_data.acceleration.acc_y,sensor1.sensor_data.acceleration.acc_z])
